...
export const usePage = () => {
  ...
  } as FinanceiroPageStates & { showPagarModal: boolean; showReceberModal: boolean });
  ...
  const handlePagarConta = (conta: ContaPagar) => {
    setContaPagar(conta);
    changeShowState("showPagarModal", true);
  };

  const handleReceberConta = (conta: ContaReceber) => {
    setContaReceber(conta);
    changeShowState("showReceberModal", true);
  };
