            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-bold text-green-600">
                  {resumoData ? formatCurrencyFromCents(resumoData.contasRecebidas) : "R$ 0,00"}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-bold text-red-600">
                  {resumoData ? formatCurrencyFromCents(resumoData.contasPagas) : "R$ 0,00"}
                </p>
              </div>
          ...
          <div className="flex w-full flex-col bg-white p-6">
            <div className="flex justify-end">
              <PageFilter
                ...
                filterCols={fluxoCaixaFilterCols}
                filters={filters}
              />
            </div>
