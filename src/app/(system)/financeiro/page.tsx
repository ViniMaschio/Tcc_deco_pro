...
import { PlusCircle, Funnel } from "lucide-react";
          ...
          >
            <div className="flex items-center justify-between border-b px-4">
              <TabsList className="h-auto bg-transparent p-0">
                <TabsTrigger
                  value="receber"
                  className="rounded-none border-b-2 border-transparent px-6 py-3 data-[state=active]:border-blue-500 data-[state=active]:bg-transparent data-[state=active]:text-blue-600 data-[state=active]:shadow-none"
                >
                  Contas a Receber
                </TabsTrigger>
                <TabsTrigger
