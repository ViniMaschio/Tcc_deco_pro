...
import { columns, localFilterCols } from "@/app/modules/local/columns";
import { LocalDataTable } from "@/app/modules/local/data-table";
import { LocalModal } from "@/app/modules/local/modal";
