...
export const ContratoAutocomplete = memo(function ContratoAutocomplete({
  ...
  const formatContratoLabel = (contrato: Contrato) => {
    ...
    const dataEvento = contrato.dataEvento
      ? moment(contrato.dataEvento).format("DD/MM/YYYY")
      : "";
    const total = typeof contrato.total === "number" ? contrato.total : centsToDecimal(contrato.total);
            ...
            <CommandEmpty>
              <div className="flex items-center justify-center py-8">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-muted-foreground text-sm">Nenhum contrato encontrado</span>
                </div>
              </div>
            </CommandEmpty>
          ) : null}
                        ...
                        <div className="flex min-w-0 flex-1 items-center gap-2">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="text-muted-foreground flex flex-wrap gap-1 text-xs">
                              ...
                              {localDesc && (
                                <span className="truncate">• {localDesc}</span>
                              )}
