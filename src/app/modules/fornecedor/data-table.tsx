...
import { fornecedorFilterCols, FornecedorFilterType } from "./columns";
import { FornecedorPageStates } from "./modal/types";
...
interface DataTableProps {
  ...
  filters: FornecedorFilterType;
  clearFilters: () => void;
  isLoading: boolean;
  showState: FornecedorPageStates;
  changeShowState: (name: keyof FornecedorPageStates, value: boolean) => void;
  removeFornecedor: () => void;
  isDeleting: boolean;
}

export function FornecedorDataTable({
  columns,
  data,
  pagination,
  setPagination,
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center">
                          {Object.keys(fornecedorFilterCols).includes(header.id) ? (
                            <>
                              {fornecedorFilterCols[header.id as keyof typeof fornecedorFilterCols]
                                .sortable ? (
                                <SortTable
                                  filters={filters}
                                  name={
                                    fornecedorFilterCols[
                                      header.id as keyof typeof fornecedorFilterCols
                                    ].sortName
                                  }
